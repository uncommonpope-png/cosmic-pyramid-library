...
export function install(Genesis, worldState, options = {}) {
  ...
  const watched = ['genesis:boot-ready', 'genesis:trust:delta', 'genesis:personality:drift', 'genesis:immortality:audit', 'genesis:prophet:archive', 'genesis:builder:schematic', 'genesis:drag:persist', 'genesis:npc:scale-pass', 'genesis:angel:life', 'genesis:scribe:live-books', 'genesis:scribe:book-open', 'genesis:memory:buildings', 'genesis:memory:building-open', 'genesis:chamber:enter', 'genesis:chamber:exit', 'genesis:chamber:feature'];
