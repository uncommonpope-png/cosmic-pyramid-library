...
export function install(Genesis, worldState, options = {}) {
  ...
  const watched = ['genesis:boot-ready', 'genesis:trust:delta', 'genesis:personality:drift', 'genesis:immortality:audit', 'genesis:prophet:archive', 'genesis:builder:schematic', 'genesis:drag:persist'];
